document.addEventListener("DOMContentLoaded", () => {
  ...
  openAddBtn?.addEventListener("click", () => {
    ...
    popupHeader.textContent = "Add New Broadcaster";
    form.reset();
    showIdInput.value = "";
  ...
  document.querySelectorAll(".edit-btn").forEach((btn) => {
    btn.addEventListener("click", () => {
      ...
      popupHeader.textContent = "Edit Broadcaster";
  ...
  document.querySelectorAll(".delete-btn").forEach((btn) => {
    btn.addEventListener("click", async () => {
      const broadcasterId = btn.dataset.id;
      ...
      try {
        const res = await fetch(`/tvstation/broadcasters/${broadcasterId}`, {
          method: "DELETE",
  ...
  form?.addEventListener("submit", async (e) => {
    ...
    const url = showId
      ? `/tvstation/broadcasters/update-broadcaster/${showId}`
      : "/tvstation/broadcasters/create-broadcaster";
