...
function addOptionBlock(text = "", imageUrl = "", description = "", link = "") {
  ...
  block.innerHTML = `
    <div class="quiz-option-inner">
      ...
      <input type="text" name="optionTexts[]" value="${text}" placeholder="Option Text" required />
      <input type="text" name="optionDescriptions[]" value="${description}" placeholder="Option Description" />
      <input type="url" name="optionLinks[]" value="${link}" placeholder="Enter URL for this option" />
